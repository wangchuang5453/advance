...
const getFullPath = (path) => {
  let publicPath = '/v4.4.0-11/';
  if (publicPath.indexOf('//') > -1) {
    let domain = publicPath.split('//')[0];
    let urlPath = publicPath.split('//')[1];
    return `${domain}//${join(urlPath, path)}`
  }
